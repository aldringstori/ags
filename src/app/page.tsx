    ...
    <div className="flex flex-col min-h-screen bg-[#000017] text-white">
      ...
      <main className="flex-grow flex flex-col items-center justify-between p-8">
        <header className="w-full max-w-5xl mb-12">
          <h1 className="text-4xl font-bold mb-2 text-white" style={{ textShadow: "0 2px 2px #00FFD0FF, 0 4px 4px #3BFFB980" }}>
        ...
        {/* Educational */}
        <section id="about" className="w-full max-w-5xl mb-12">
          <h2 className="text-2xl font-semibold mb-4 text-white drop-shadow-[0_1px_1px_rgba(0,255,208,0.8)]">Educational</h2>
        ...
        <section id="projects" className="w-full max-w-5xl mb-12">
          <h2 className="text-2xl font-semibold mb-4 text-white drop-shadow-[0_1px_1px_rgba(0,255,208,0.8)]">Projects</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              { title: "Joi", description: "A virtual AI friendly companion" },
            ].map((project, index) => (
        ...
        <section id="contact" className="w-full max-w-5xl">
          <h2 className="text-2xl font-semibold mb-4 text-white drop-shadow-[0_1px_1px_rgba(0,255,208,0.8)]">Contact</h2>
          <p className="text-lg text-[#E6F3FF]">
            Feel free to reach out to me at{" "}
            <a href="mailto:aldrinstori@gmail.com" className="text-[#00DEFF] hover:underline">
             aldrinstori@gmail.com
            </a>
          </p>
        </section>
